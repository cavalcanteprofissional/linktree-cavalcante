...
const GITHUB_URL = "https://github.com/cavalcanteprofissional";
  ...
  return (
    <div className="flex flex-col items-center gap-4 text-center">
      {avatar ? (
        <div className="relative inline-block">
          <a
            ...
            className="block w-24 h-24 rounded-full group"
            style={{
              boxShadow:
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs sm:text-sm text-muted-foreground whitespace-nowrap overflow-hidden text-ellipsis">{bio}</p>
      </div>
    </div>
  );
}
